...
const ShowFormData = () => {
  ...
  const fetchDataFromApi = async () => {
    try {
      let response = await fetch(`https://fair-erin-millipede-gear.cyclic.app/read`);
  ...
  return (
    <div className="flex justify-center h-full border-2 border-black">
      <div className="  border-2 px-8 py-4 my-2 border-gray-400 w-[60%]  mt-16 mb-4 mx-8 rounded-md">
        <h2 className="text-center my-4 text-4xl text-sky-900 underline">
          Form Data
        </h2>
